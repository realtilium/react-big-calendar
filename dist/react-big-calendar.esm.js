...
var VIEWS = {
  month: withStatics(/*#__PURE__*/ React.memo(MonthView, areEqual), MonthView),
  week: withStatics(/*#__PURE__*/ React.memo(Week, areEqual), Week),
  day: withStatics(/*#__PURE__*/ React.memo(Day, areEqual), Day),
  agenda: withStatics(/*#__PURE__*/ React.memo(Agenda, areEqual), Agenda),
  work_week: withStatics(
    /*#__PURE__*/ React.memo(WorkWeek, areEqual),
    WorkWeek
  ),
}
